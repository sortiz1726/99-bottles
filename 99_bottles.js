...
function bottleLineOne(bottleCount)
{
    ...
    return capitalize(message + " of beer on the wall, " + message + " of beer.");
}
...
function bottleLine(bottleCount)
{
    return bottleLineOne(bottleCount) + "\n" + bottleLineTwo(bottleCount - 1);
}
